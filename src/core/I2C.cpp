...
TwoWire::TwoWire()
{
	sercom = (SERCOM_I2C *) 0xE01000000;
	master_mode_clock = DEFAULT_TWI_CLOCK;
	transmissionBegun = false;
}


void TwoWire::configIO(SERCOM *scm, PinTuple SDA, PinTuple SCL)
{
	sercom = scm->bind<SERCOM_I2C>(this);
	pinMode(SDA, SDA.iomux());
	pinMode(SCL, SCL.iomux());
}
